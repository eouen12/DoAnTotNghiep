...
namespace QuanLyCuaHangNoiThat {
    ...
    public partial class QuanLyCuaHangNoiThatDataSet1 : global::System.Data.DataSet {
        ...
        public partial class KHACHHANGDataTable : global::System.Data.TypedTableBase<KHACHHANGRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public KHACHHANGRow AddKHACHHANGRow(string TENKH, string SDT, string DIACHI, string CMND, bool TRANGTHAI) {
...
namespace QuanLyCuaHangNoiThat.QuanLyCuaHangNoiThatDataSet1TableAdapters {
    ...
    public partial class KHACHHANGTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[KHACHHANG] ([TENKH], [SDT], [DIACHI], [CMND], [TRANGTHAI]) VAL" +
                "UES (@TENKH, @SDT, @DIACHI, @CMND, @TRANGTHAI);\r\nSELECT MAKH, TENKH, SDT, DIACHI" +
                ", CMND, TRANGTHAI FROM KHACHHANG WHERE (MAKH = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[KHACHHANG] SET [TENKH] = @TENKH, [SDT] = @SDT, [DIACHI] = @DIACHI, [CMND] = @CMND, [TRANGTHAI] = @TRANGTHAI WHERE (([MAKH] = @Original_MAKH) AND ((@IsNull_SDT = 1 AND [SDT] IS NULL) OR ([SDT] = @Original_SDT)) AND ((@IsNull_CMND = 1 AND [CMND] IS NULL) OR ([CMND] = @Original_CMND)) AND ([TRANGTHAI] = @Original_TRANGTHAI));
SELECT MAKH, TENKH, SDT, DIACHI, CMND, TRANGTHAI FROM KHACHHANG WHERE (MAKH = @MAKH)";
        ...
        public virtual int Fill(QuanLyCuaHangNoiThatDataSet1.KHACHHANGDataTable dataTable) {
        ...
        public virtual QuanLyCuaHangNoiThatDataSet1.KHACHHANGDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QuanLyCuaHangNoiThatDataSet1.KHACHHANGDataTable dataTable = new QuanLyCuaHangNoiThatDataSet1.KHACHHANGDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QuanLyCuaHangNoiThatDataSet1.KHACHHANGDataTable dataTable) {
        ...
        public virtual int Delete(int Original_MAKH, string Original_SDT, string Original_CMND, bool Original_TRANGTHAI) {
        ...
        public virtual int Insert(string TENKH, string SDT, string DIACHI, string CMND, bool TRANGTHAI) {
            if ((TENKH == null)) {
        ...
        public virtual int Update(string TENKH, string SDT, string DIACHI, string CMND, bool TRANGTHAI, int Original_MAKH, string Original_SDT, string Original_CMND, bool Original_TRANGTHAI, int MAKH) {
            if ((TENKH == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TENKH, string SDT, string DIACHI, string CMND, bool TRANGTHAI, int Original_MAKH, string Original_SDT, string Original_CMND, bool Original_TRANGTHAI) {
            return this.Update(TENKH, SDT, DIACHI, CMND, TRANGTHAI, Original_MAKH, Original_SDT, Original_CMND, Original_TRANGTHAI, Original_MAKH);
        }
    }
